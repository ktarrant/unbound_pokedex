...
from convert.names import (
    get_pokedex_outline,
    parse_blurbs,
    parse_names,
    name_mapper,
)
from convert.merge import (
    merge_species_data,
    create_evolves_from,
...
# Start with the base outline based on the species mapping
pokedex = get_pokedex_outline()
...
# Next add the Base Data for each species
base_stats = parse_base_stats()
merge_species_data(pokedex, base_stats)

# Add evolution data
evolutions = parse_evolutions()
merge_species_data(pokedex, evolutions, "evolve_to")
create_evolves_from(pokedex)

# Add Moves Data
egg_moves = parse_egg_moves()
merge_species_data(pokedex, egg_moves, "egg_moves")
